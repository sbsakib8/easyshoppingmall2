...
function Categories() {
    return (
        <div className="container">
            ...
            <div>
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4 mt-5">
                    
                    {
                        categoridata.map((itme) => {
                            return (
                                <div key={itme.id} className="bg-white group relative cursor-pointer w-[140px] h-[140px] p-4 rounded-full shadow-md hover:shadow-lg hover:opacity-80 transition-shadow duration-300 my-5">
